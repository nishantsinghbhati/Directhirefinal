...
const HeroSection = () => (
  <section className="relative  sm:mt-0 h-screen flex items-center  justify-center ">
   
    <div className="text-blsck text-center px-4">
...
const AboutUs = () => {
  return (
    <div><div
      className="absolute w-full h-full object-cover bg-blue-200 -z-10"
