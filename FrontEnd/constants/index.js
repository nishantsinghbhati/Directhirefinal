...
const navLinks2 = [
  { label: "Resume Maker", destination: "/resume-maker" },
  { label: "Contact", destination: "/contact" },
];
const navLinks2opt = [
  { label: "Job Seekers", destination: "/job-seeker" },
  { label: "Hire Talent", destination: "/hire-talent" },
];
...
const candidatereviews = [
  ...
  },
  {
    ...
    image: '/9.webp',
    review: 'Priyanshi was very helpful throughout the process. I am truly grateful for the effort she made to understand my goals.',
    stars: 5
  },
  {
    name: 'Ritika Chauhan',
    ...
    image: '/3.webp',
    review: 'Direct Hire has a broad network of companies that they hire for and uses a professional approach.',
    stars: 4
  },
  {
    name: 'Karan Malhotra',
...
const industryData = [
  ...
  },
  {
    ...
    link: "",
    icon: "/information-technology_17735653.webp",
  },
  {
